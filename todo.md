Ensure the continuous playback of track:
Ensure all the filetypes are played at pure level. Complete Raw Sound.
...
Fix AutoMix and Crossfade, the consistent track playback is not one go. It often stops, preload all the tracks.
